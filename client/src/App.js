    ...
    <>
            ...
            <div className="Navbar fixed-top">
              <ul className="navbar-Nav">
                ...
                <div id="desktop">
                  ...
                  <li className="nav-item">
                    {" "}
                    <a href="/testimonial" className="text-white nav-link">
                      Testimonials<i className="bi bi-file-person"></i>
                    </a>
                  </li>
                  <li className="nav-item">
                    {" "}
                    <a href="#credits" className="text-white nav-link">
                      Credits
                    </a>
                  </li>
                </div>
                    ...
                    <ul style={{ listStyle: "none" }}>
                      <li>
                        <a
                          ...
                          role="button"
                        >
                          Log in with <i className="bi bi-google"></i>oogle
                        </a>
                      </li>
                      <li>
      ...
      {data && (
        <>
          ...
          >
            <p style={{ textAlign: "center", width: "65%" }}>
              Welcome to Quickstart!. It is an app developed to deliver from all
              of your favourite restaurants. Our app has an average overall
              rating {data.avgExperience}/10. <br /> If you don't have an
              account, not to worry one will be created upon logging in with{" "}
              <i className="bi bi-google"></i>oogle.
              <br />
              <h4 className="text-danger">Note: Please use your BITS email</h4>
            </p>
          </div>
          <div id="d1"></div>
